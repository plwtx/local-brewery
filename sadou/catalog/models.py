...
class Book(models.Model):
    ...
    author = models.ManyToManyField('Author', help_text='Enter a book author')

    # Change from ManyToManyField to ForeignKey
    """For single author"""
    # author = models.ForeignKey('Author', on_delete=models.SET_NULL, null=True, help_text='Enter a book author')
    ...
    """For single author"""
    # def display_author(self):
    # """Create a string for the Author."""
