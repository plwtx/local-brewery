...
class Language(models.Model):
    ...
    name = models.CharField(max_length=200, help_text='Enter the language of the brew')
...
class Brew(models.Model):
    ...
    language = models.ForeignKey(Language, on_delete=models.SET_NULL, null=True, help_text='Select a language for this brew')
